...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full h-[70px] bg-yellow flex items-center justify-between px-10 z-[1000] transition-transform duration-[350ms] ease-in-out ${
    ...
    >
      ...
      <div className="flex-1 text-center">
        <a href="#home" className="flex items-center justify-center h-full">
          <Image src="/logo.jpeg" alt="Prince Achar" width={70} height={70} className="h-full w-auto object-contain" />
        </a>
      </div>

      <div className="flex items-center gap-5 flex-1 justify-end">
        <a href="#login" className="text-red text-[18px] hover:opacity-70 transition-opacity">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
          </svg>
        </a>
        <a href="#cart" className="text-red text-[18px] hover:opacity-70 transition-opacity">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
