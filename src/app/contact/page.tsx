      ...
      <section className="bg-white pb-10 md:pb-14">
        <div className="max-w-[1150px] mx-auto px-6">
          <div className="bg-yellow rounded-[14px] border border-brand-black/8 px-5 md:px-7 py-6 md:py-7">
            <div className="grid grid-cols-2 md:grid-cols-[1.8fr_1fr_1fr_1fr] gap-x-6 gap-y-6 md:divide-x md:divide-brand-black/10">
              {reachItems.map((item, i) => (
                <div key={i} className={`flex gap-3 ${i === 0 ? "col-span-2 md:col-span-1" : ""}`}>
